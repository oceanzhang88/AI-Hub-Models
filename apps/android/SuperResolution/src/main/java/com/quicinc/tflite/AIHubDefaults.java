...
public class AIHubDefaults {
    ...
    // Add these to the AIHubDefaults class
    public static final TFLiteHelpers.DelegateType[][] npuDelegatePriorityOrder = new TFLiteHelpers.DelegateType[][] {
            { TFLiteHelpers.DelegateType.QNN_NPU }
    };

    public static final TFLiteHelpers.DelegateType[][] gpuDelegatePriorityOrder = new TFLiteHelpers.DelegateType[][] {
            { TFLiteHelpers.DelegateType.GPUv2 }
    };

    public static final TFLiteHelpers.DelegateType[][] cpuDelegatePriorityOrder = new TFLiteHelpers.DelegateType[][] {
            {} // An empty set falls back to the CPU
    };
